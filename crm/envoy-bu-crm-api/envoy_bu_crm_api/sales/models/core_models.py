...
class TaskStatus(models.Model):
    class StatusType(models.TextChoices):
        TODO = "task_todo", "To Do"
        IN_PROGRESS = "task_inprogress", "In Progress"
        DONE = "task_done", "Done"
...
class Task(models.Model):
    ...
    assigned_to = models.ForeignKey("sales.User", on_delete=models.SET_NULL, null=True, blank=True, related_name="assigned_tasks")
...
class Entity(models.Model):
    ...
    created_by = models.ForeignKey("sales.user", on_delete=models.RESTRICT, related_name="entities_created",null=True, blank=True, default=None
    )
    updated_by = models.ForeignKey("sales.user", on_delete=models.RESTRICT, related_name="entities_updated",null=True, blank=True, default=None)

...
function AdminLayout({
  ...
  const [hasNotifications, setHasNotifications] = useState(false); // State to manage notifications
    ...
    <UserLocale value={locale}>
      <UserPermissions value={authUserPermissions}>
        <CurrencyProvider>
          <BreadcrumbProvider>
            <body
              style={{ '--bs-body-font-family': 'var(--font-inter)' } as React.CSSProperties}

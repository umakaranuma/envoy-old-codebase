...
const HeaderContentLeft = ({ handleMenuToggleClick, sbClosed, appMenu }: { handleMenuToggleClick: Function; sbClosed: boolean; appMenu: any[] }) => {
...
const HeaderContentRight = ({ themeMode, hasNotifications }: { themeMode: 'light' | 'dark'; hasNotifications: boolean }) => {
  ...
  return (
    <div className="header-content-right">
      ...
      {/* <NotificationDropdown themeMode={themeMode} hasNotifications={hasNotifications} /> */}

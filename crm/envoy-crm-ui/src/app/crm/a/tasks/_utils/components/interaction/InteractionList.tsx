...
import { fetchAllInteractionTableData } from '../../service';
import { Button } from '@apptimus-ui/ui-element';

function InteractionList({ tableVers, handleOnDelete, setCreateFormVisible, onView }: { tableVers: number; handleOnDelete: Function; setCreateFormVisible: Function; onView: Function }) {
  ...
  const tableProperties = useAsyncTable({
    ...
    loadData: (props: any) => fetchAllInteractionTableData(props, taskId),
    paginate: true,
    rowSelection: true,
    rowSelectionProp: {
      key: 'id',

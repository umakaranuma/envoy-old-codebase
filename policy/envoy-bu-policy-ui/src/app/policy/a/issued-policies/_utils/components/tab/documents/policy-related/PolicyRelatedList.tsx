...
function PolicyRelatedList({ onEdit, tableVers, handleOnDelete, policyId }: { onEdit: Function; tableVers: number; handleOnDelete: Function; policyId: string }) {
  ...
  const tableProperties = useAsyncTable({
    columns: columns,
    loadData: (props: any) => fetchAllIssuedPolicyDocumentTableData(props, policyId, 'policy-related'),
    paginate: true,
    rowSelection: true,
    rowSelectionProp: {
      key: 'doc',
...
export default PolicyRelatedList;

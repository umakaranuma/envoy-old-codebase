...
function EditRiskDocument({ isOpen, editId, onCancel, afterSave }: { isOpen: boolean; editId: string; onCancel: Function; afterSave: Function }) {
...
export default EditRiskDocument;

...
function AddRiskDocument({ isOpen, onCancel, afterSave, issuedPolicyId }: { isOpen: boolean; onCancel: Function; afterSave: Function; issuedPolicyId: string }) {
    ...
    try {
      ...
      const data = documents.map((res: any, index) => {
        return {
          ...
          notes: res.notes,
          document_category: 'Risk-Related',
        };
      });
            ...
            <div className="col-12 mb-3">
              {resources.length > 0 ? (
                ...
                <div className="col-12 mb-3">
                  ...
                  <Input type="file" multiple onChange={fileChange} className="form-control error-documents" />
                </div>
              )}
...
export default AddRiskDocument;

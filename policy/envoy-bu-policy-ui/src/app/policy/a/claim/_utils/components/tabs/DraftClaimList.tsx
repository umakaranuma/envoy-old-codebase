...
function DraftClaimList({ onView, onEdit, tableVers, selectedIds }: { onView: Function; onEdit: Function; tableVers: number; selectedIds: Function }) {
  ...
  const columns = useMemo<ITablePropertyColumn[]>(
    () => [
      ...
      // },
      {
        ...
        //     style={{
        //       background: hexToRgba(cell.color ? cell.status_color : '', 0.1),
  ...
  const tableProperties = useAsyncTable({
    ...
    loadData: (props: any) => fetchClaimTableData(props, 'claim_draft'),
    paginate: true,
    rowSelection: true,
    rowSelectionProp: {
      key: 'id',
      ...
      //disableRowFn: (row: any) => (row.status_type !== 'claim_draft' ? true : false),
    },
    customState: {
      initState: {
        filters: {},

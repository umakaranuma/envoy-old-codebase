    ...
    <>
      <div className="mb-4">
        ...
        <div className="row">
          <div className="col-12 col-md-4 mb-3">
            <Description label={t('vehicle_type')} value={data?.name || '-'} skeleton={skeleton} />
          </div>
          <div className="col-12 col-md-4 mb-3">
          ...
          <div className="col-12 col-md-4 mb-3">
            <Description label={t('mileage')} value={data?.description || '-'} skeleton={skeleton} />
          </div>
          <div className="col-12 col-md-4 mb-3">
      ...
      <div className="d-flex justify-content-start gap-2 mt-3">
        <Button
          ...
          onClick={() => {
            router.push(`/policy/a/claim/${claimId}?t=policyholder_info`);
          }}
        >
        ...
        <Button color="primary" className="d-flex align-items-center gap-1" onClick={() => router.push(`/policy/a/claim/edit/?claimId=${claimId}&t=vehicle_info`)}>

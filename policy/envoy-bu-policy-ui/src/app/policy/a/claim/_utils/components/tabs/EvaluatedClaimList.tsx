...
function EvaluatedClaimList({ onView, onEdit, tableVers, selectedIds }: { onView: Function; onEdit: Function; tableVers: number; selectedIds: Function }) {
  ...
  const tableProperties = useAsyncTable({
    ...
    loadData: (props: any) => fetchClaimTableData(props, 'claim_submitted'),
    paginate: true,
    rowSelection: false,
    rowSelectionProp: {
      key: 'id',
...
export default EvaluatedClaimList;

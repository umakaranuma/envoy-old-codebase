  ...
  return (
    <>
      <Modal isOpen={isOpen} position={position}>
        ...
        <div className="d-flex justify-content-end mt-2 gap-2 px-3 pb-4">
          <Button text={yesButtonLabel} width="sm" onClick={() => onYes()} isLoading={isFormProcessing} />
          <Button text={noButtonLabel} color="light" width="sm" onClick={() => onCancel()} />
        </div>
      </Modal>
    </>
  );

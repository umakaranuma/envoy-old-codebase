...
import QuillEditor from '@/components/others/page-related/QuillEditor';
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (responseData.status_code === 417) {
        ...
        printError(responseData.result, form.chat.store, tBe);
      }
    ...
    <form onSubmit={onSubmit} id={`${form.chat.store}`}>
      <div className="row mt-4 py-5 px-3">
        ...
        <div className="mb-3">
          ...
          <QuillEditor
            onChange={(body: any) => {
              onFormChange('body', body), setError('');
            }}
          />
        </div>

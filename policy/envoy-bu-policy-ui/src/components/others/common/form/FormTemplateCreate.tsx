...
import { IFormTemplate, IElement, Step } from './template-modal';
import FormStepper from './FormStepper';
import { getFormsElements } from './api-service';

function FormTemplateCreate({
  templateId,
  onBack,
  isFormProcessing,
  onSubmit,
  ...
  const fetchTemplateData = async () => {
    if (templateId) {
      const responseData = await getFormsElements(templateId);

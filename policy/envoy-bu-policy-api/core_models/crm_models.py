...
# RiskDetail model has been replaced with Risk and RiskSubmission models below
...
class Risk(models.Model):
    ...
    risk_type = models.ForeignKey(OpportunityType, on_delete=models.SET_NULL, null=True, blank=True, db_column='risk_type_id', related_name='risks')
...
class RiskSubmission(models.Model):
    ...
    lead_id = models.ForeignKey(Opportunity, on_delete=models.SET_NULL, null=True, blank=True, db_column='lead_id', related_name='submission_risks')

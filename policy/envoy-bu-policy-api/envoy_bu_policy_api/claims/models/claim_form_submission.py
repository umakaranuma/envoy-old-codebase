...
from core_models.core_models import CoreFormSubmission
from envoy_bu_policy_api.claims.models.claim import Claim
# from envoy_bu_policy_api.claims.models.claim_form_config import ClaimFormConfig
...
class ClaimFormSubmission(models.Model):
    ...
    form_submission = models.ForeignKey(CoreFormSubmission, on_delete=models.CASCADE)

...
from envoy_bu_policy_api.policy.models.crmp_request_policy_invoices import RequestPolicyInvoice
...
class Payment(models.Model):
    ...
    entity = models.ForeignKey("core_models.Entity", related_name='payment_entity', on_delete=models.CASCADE,default=1)

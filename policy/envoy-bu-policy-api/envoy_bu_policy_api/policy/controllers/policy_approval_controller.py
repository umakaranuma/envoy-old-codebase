...
import json
from envoy_bu_policy_api.service import send_approval_email_helper,get_recipient_email_by_customer_id
...
def get_all_policy_approvals(request, policy_id=None):
    ...
    query = (
        ...
        .leftJoin(
            "core_vendor_products as products", "products.id", "interested_products.product_id"
        )

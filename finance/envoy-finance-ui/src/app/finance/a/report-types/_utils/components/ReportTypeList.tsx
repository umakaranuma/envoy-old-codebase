...
import { fetchAllReportTypesTableData } from '../service';

function ReportTypeList({ handleOnDelete, onView, onEdit, tableVers }: { handleOnDelete: Function; onView: (id: string) => void; onEdit: (id: string) => void; tableVers: number }) {
  ...
  const tableProperties = useAsyncTable({
    ...
    loadData: (props: any) => fetchAllReportTypesTableData(props),
    paginate: true,
    rowSelection: true,
    rowSelectionProp: {
      key: 'id',

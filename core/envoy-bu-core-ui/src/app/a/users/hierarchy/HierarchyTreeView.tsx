...
import AccountsCreate from '../../accounts/_utils/components/AccountsCreate';
import { deleteHierarchies } from '../../accounts/_utils/api-service';
...
export default function HierarchyTree({ data, name, afterNodeCreation, id }: ComponentProps) {
  ...
  return (
    <div id="tree-container" className="hierarchy-tree-container mt-4">
      <Tree
        data={treeData}

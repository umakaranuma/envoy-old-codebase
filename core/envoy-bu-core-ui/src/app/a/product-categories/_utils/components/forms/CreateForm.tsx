...
import { createTypesOfForm } from '../../api-service';
import { AsyncSelect, Select } from '@apptimus-ui/select';
import { fetchAllFormsData } from '../../services';

function CreateForm({ isOpen, onCancel, afterSave, viewId }: { isOpen: boolean; onCancel: Function; afterSave: Function; viewId: string }) {
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      const responseData = await createTypesOfForm(viewId, formData);
          ...
          <div className="row">
            ...
            <div className="col-12 col-md-6 mb-3 custom-select">
              ...
              <Select
                ...
                options={data}
                className="form-control error-data_gethering_type"
                option={{
                  label: 'label',
                  value: 'id',

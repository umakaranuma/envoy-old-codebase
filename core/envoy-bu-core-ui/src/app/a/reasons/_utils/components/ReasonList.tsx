...
import { fetchReasonTableData } from '../services';
import ReasonFilter from './ReasonFilter';
import { filterReducer } from '@/helpers/services/dataReducer';

function ReasonList({ tableVers, onView, onEdit, handleOnDelete }: { tableVers: number; onView: Function; onEdit: Function; handleOnDelete: Function }) {
  const t = useTrans('label.reason,otr.common');
  const tableName = 'reason';

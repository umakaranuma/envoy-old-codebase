...
import { fetchMergeableAccounts } from '../../service';

function AccountsList({ tableVers, onView, viewId }: { tableVers: number; onView: Function; viewId: string }) {
  ...
  const tableProperties = useAsyncTable({
    ...
    loadData: async (props: any) => {
      return await fetchMergeableAccounts({ ...props, id: viewId });
    },
    paginate: true,
    rowSelection: true,
    rowSelectionProp: {

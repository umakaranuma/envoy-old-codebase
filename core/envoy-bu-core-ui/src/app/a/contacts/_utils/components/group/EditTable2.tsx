...
import { fetchAllContactsOfGroup } from '../../service';

function EditTable2({ tableVers, selectedValues, groupId }: { tableVers: number; selectedValues: Function; groupId: string }) {
  ...
  const tableProperties = useAsyncTable({
    ...
    loadData: (params: any) => fetchAllContactsOfGroup(params, groupId),
    paginate: true,
    rowSelection: true,
    rowSelectionProp: {
      key: 'id',

...
import { fetchChannelsTableData } from '../services';

function ChannelsList({ tableVers, onView, onEdit, handleOnDelete }: { tableVers: number; onView: Function; onEdit: Function; handleOnDelete: Function }) {
  ...
  const tableProperties = useAsyncTable({
    ...
    loadData: fetchChannelsTableData,
    paginate: true,
    rowSelection: true,
    rowSelectionProp: {
      key: 'id',

...
import { fetchCustomerRequestPolicyTableData } from '../../service';

function PolicyList({ onView, setCurrentApprovalId, tableVer }: { onView: Function; setCurrentApprovalId: Function; tableVer: number }) {
  const t = useTrans('label.customer_request,otr.common');
  const tableName = 'policy_list';
  ...
  const tableProperties = useAsyncTable({
    ...
    loadData: (props: any) => fetchCustomerRequestPolicyTableData(props),
    paginate: true,
    rowSelection: true,
    rowSelectionProp: {
      key: 'id',

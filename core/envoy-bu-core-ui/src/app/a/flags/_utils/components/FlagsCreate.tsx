...
function FlagsCreate({ isOpen, onCancel, afterSave }: { isOpen: boolean; onCancel: Function; afterSave: Function }) {
  ...
  return (
    <Modal isOpen={isOpen}>
      <ModalHeader title={t('add_new_flag')} onClose={() => onCancel()} />

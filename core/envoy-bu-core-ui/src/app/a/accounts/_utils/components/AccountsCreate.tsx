...
function AccountsCreate({ isOpen, onCancel, afterSave, parent_id = null, id }: { isOpen: boolean; onCancel: Function; afterSave: Function; parent_id?: string | null; id?: any }) {
          ...
          <form id={`${form.select_customer.store}`}>
            <div className="col-12 col-md-6 mb-3 custom-select">
              ...
              <AsyncSelect
                ...
                isSearchable={true}
                loadOptions={(searchValue, currentPage) => fetchAllCustomers(searchValue, currentPage, id)}
              />
            </div>
          </form>
        ) : (

...
function RecordController({ tableProperties, isRowPerPageVisible, isPaginationTextVisible }: any) {
  ...
  return (
    <div className="d-flex justify-content-end align-items-center gap-5 my-4 text fs-table" style={{ textWrap: 'nowrap' }}>
      {isRowPerPageVisible && (

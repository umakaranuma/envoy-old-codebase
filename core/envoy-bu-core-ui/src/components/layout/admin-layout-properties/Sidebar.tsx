...
export const Sidebar = ({ children, handleSidebarOverlay, bottomMenus }: { children: React.ReactNode; handleSidebarOverlay: Function; bottomMenus: MenuCategory[] }) => {
  return (
    <aside className="app-sidebar sticky" id="sidebar" onMouseEnter={() => handleSidebarOverlay(true)} onMouseLeave={() => handleSidebarOverlay(false)}>
      ...
      <div className="main-sidebar" id="sidebar-scroll">
        ...
        <nav className="main-menu-container nav nav-pills flex-column sub-open">
          ...
          {/* Bottom menus - added at the end */}
          <div className="sidebar-bottom-menus">
            <SidebarMenu handleMenuToggleClick={() => {}} appMenu={bottomMenus} />
          </div>
        </nav>
        {/* End::nav */}
      </div>

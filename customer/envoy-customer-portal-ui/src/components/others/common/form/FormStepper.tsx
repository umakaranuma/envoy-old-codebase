...
function FormStepper({ steps, currentTabId, templateName }: { steps: Step[]; currentTabId: number; templateName?: string }) {
  return (
    <div className="card-body bg-white p-3 rounded-3 mb-3 overflow-x-auto" style={{ scrollbarWidth: 'none' }}>
      {templateName && (
        <div className="mb-3">
